...
class RepeatingFreeStreamer:
    def __init__(self, initial, grid_max, nframes, dt, vfs):
    ...
    def __call__(self, n):
        ...
        fs = freestream.FreeStreamer(self.initial, self.grid_max, t, self.vfs)
        return t, fs.Tuv(0, 0)
...
def main():
    ...
    frames = [(0, initial)]
    rfs = RepeatingFreeStreamer(initial, args.grid_max, nframes, dt, vfs)
